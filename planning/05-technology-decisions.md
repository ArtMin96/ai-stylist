...
**Status:** Ratified (mirrors [SPINE.md §2](SPINE.md)) · **Date:** 2026-08-24 · **Amended:** 2026-09-09 — prices re-verified in [r6](research/r6-pricing-verification-2026-09-09.md); §6, §6.2, §8 assumption A10 and §9 pins updated (DEC-34/35) · **Amended:** 2026-09-13 ([r7](research/r7-third-party-services-and-self-hosting-audit-2026-09-13.md), ADR-0003 — services re-audited: §5.3–5.7, §6, §6.2, §8 A11/A12, §9 updated; DEC-41..48) · **Amended:** 2026-09-22 ([ADR-0004](../docs/adr/0004-native-ios-and-android-clients.md), DEC-49–54: native iOS/Android replace React Native + Expo. Updated §1, §2 (new §2.0; §2.1–2.3 kept as history), §3, §5.2, §5.8, §6, §7, §8 A1–A5, §9) · **Amended:** 2026-09-26 ([ADR-0006](../docs/adr/0006-track-latest-stable-toolchains.md), DEC-56: toolchains and dependencies track the latest stable release. Updated §1, §5.3, §9). **Versions as of Aug 2026, prices as of 2026-09-09 unless noted; services re-audited 2026-09-13; toolchains re-pinned 2026-09-26.**
...
| Database / vectors | Self-managed PostgreSQL 18 + pgvector (Docker, owned host), Drizzle ORM | [§5.3](#53-database-self-managed-postgresql-18--pgvector--drizzle) | P02-T07 / P14 drill |
...
| Android toolchain | AGP 9.4.1 · Gradle 9.8.0 (AGP 9.4.1 emits setVisible deprecation problems; not errors; build-logic uses kotlin-jvm 2.4.20 instead of kotlin-dsl, which clears GHSA-r937-wjx7-w2jp) · Kotlin 2.4.20 · Compose BOM 2026.09.00 · compileSdk 37 / targetSdk 37 / minSdk 29 · JDK Temurin 25 LTS | 2026-09-22, official release notes (ADR-0004, DEC-54); bumped 2026-09-26 (ADR-0006, DEC-56) |
| Server / tooling runtimes | Node.js 24 (Active LTS) · pnpm 12 · Python 3.14 · PostgreSQL 18 + pgvector · NestJS 12 on Fastify 5 · TypeScript 6.0 (7 held: typescript-eslint peer range) | 2026-09-26, official release notes (ADR-0006, DEC-56); exact pins in `mise.toml` and the package manifests |
