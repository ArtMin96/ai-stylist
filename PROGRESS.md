...
- **Last green:** `just ci-parity`, 2026-09-11 (locally and on GitHub: PR #1 and PR #2 runs).
- **Latest handoff:** [`planning/PROGRESS.md`](planning/PROGRESS.md) → "Session handoff log" → entry dated 2026-09-11 (P02 sops + age repository hardening); next action in its "Next session starts here" section.
