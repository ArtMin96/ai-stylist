...
package app.aistylist.contracts.client.infrastructure
...
import app.aistylist.contracts.client.infrastructure.Serializer.kotlinxSerializationJson
...
class ApiClient(
    ...
    companion object {
        protected const val BASE_URL_KEY: String = "app.aistylist.contracts.client.baseUrl"
        @Deprecated(
