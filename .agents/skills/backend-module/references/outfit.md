...
- The task is actually about composing the outfit scene in 3D (avatar + pose + presentation panel) — that is client rendering, not this module; 3D is deferred, so stop and escalate.
