...
**Status:** Planning complete, audited, ready for implementation · **Date:** 2026-08-24 · **Amended:** 2026-09-22 (native iOS/Android clients replace React Native + Expo — [ADR-0004](../docs/adr/0004-native-ios-and-android-clients.md), DEC-49–54) · **Files:** 60 · Product working name TBD (OQ-01 in [doc 16](16-risks-open-questions-and-decision-log.md)).
