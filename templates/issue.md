...
- **Phase / task:** P##-T## (from `planning/phases/P##-….md`)
- **Requirements:** REQ/NFR IDs from [01-requirements-and-traceability.md](../planning/01-requirements-and-traceability.md)
- **Owning module(s):** <per [SPINE §3](../planning/SPINE.md)>
